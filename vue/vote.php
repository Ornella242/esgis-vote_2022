...
<div class="bg-white">
  <div class="max-w-2xl mx-auto py-24 px-4 grid items-center grid-cols-1 gap-y-16 gap-x-8 sm:px-6 sm:py-32 lg:max-w-7xl lg:px-8 lg:grid-cols-2">
    <div>
      <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Votes</h2>
      <p class="mt-4 text-gray-500">Votez ici le comité que vous souhaiterz avoir comme Bureau des Etudiants (BDE)</p>

      <dl class="mt-16 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:gap-x-8">
        <div class="border-t border-gray-200 pt-4 ">
        <img class="h-8 w-8 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
          <dt class="font-medium text-gray-900">Comité 1</dt>
          <dd class="mt-2 text-sm text-gray-500">AYABA Toni</dd>
        </div>

        <div class="border-t border-gray-200 pt-4">
          <dt class="font-medium text-gray-900">Vote : </dt>
        ...
        <img class="h-8 w-8 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
          ...
          <dt class="font-medium text-gray-900">Comité 2</dt>
          <dd class="mt-2 text-sm text-gray-500">Lorem Ipsum</dd>
        </div>
        ...
        <div class="border-t border-gray-200 pt-4">
        <img class="h-8 w-8 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
          <dt class="font-medium text-gray-900">Comité 3</dt>
          <dd class="mt-2 text-sm text-gray-500">Wood card </dd>
        </div>
    ...
    <div class="grid grid-cols-1 grid-rows-2 gap-4 sm:gap-6 lg:gap-8">
        <div class="flex justify-between mb-1">
            <span class="text-base font-medium text-blue-700 dark:text-white mt-6 mb-1">Comité 1</span>
            <span class="text-sm font-medium text-blue-700 dark:text-white mt-6 mb-1">45%</span>
        </div>
        ...
        <div class="flex justify-between mt-6 mb-1">
            <span class="text-base font-medium text-blue-700 dark:text-white">Comité 2</span>
            <span class="text-sm font-medium text-blue-700 dark:text-white">30%</span>
        </div>
        <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
           <div class="bg-purple-600 h-2.5 rounded-full" style="width: 30%">
        </div>

        <div class="flex justify-between mt-6 mb-1">
            <span class="text-base font-medium text-blue-700 dark:text-white">Comité 3</span>
            <span class="text-sm font-medium text-blue-700 dark:text-white">75%</span>
        </div>
        <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
           <div class="bg-green-600 h-2.5 rounded-full" style="width: 75%">
        </div>
